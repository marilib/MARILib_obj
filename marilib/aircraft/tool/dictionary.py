...
DATA_DICT = {
    ...
    "shield_parameter": {"unit":"bar.l/kg", "mag":1e2, "txt":"Tank structural efficiency"},
    "shield_density": {"unit":"kg/m3", "mag":1e3, "txt":"Tank shell material density"},
    "insulation_thickness": {"unit":"m", "mag":1e-1, "txt":"Tank insulation thickness"},
    "insulation_density": {"unit":"kg/m3", "mag":1e3, "txt":"Tank insulation material density"},
    "fuel_pressure": {"unit":"bar", "mag":1e2, "txt":"Maximum over pressure of the fuel in the tank"},
    "shell_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Ratio of shielding and insulation mass over max fuel mass"},
    ...
    "shield_volume": {"unit":"m3", "mag":1e1, "txt":"Tank shielding volume"},
    "shield_mass": {"unit":"kg", "mag":1e3, "txt":"Tank shielding mass"},
    "insulation_volume": {"unit":"m3", "mag":1e1, "txt":"Tank insulation volume"},
    "insulation_mass": {"unit":"kg", "mag":1e2, "txt":"Tank insulation mass"},
