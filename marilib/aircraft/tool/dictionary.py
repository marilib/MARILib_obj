...
DATA_DICT = {
    ...
    "gravimetric_energy_density_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Tank system energy density over fuel energy density"},
    "volumetric_energy_density_ratio": {"unit":"no_dim", "mag":1e0, "txt":"Tank system energy density over fuel energy density"},
