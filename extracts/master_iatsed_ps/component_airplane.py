...
class Airplane(object):
    ...
    def print_airplane_data(self):
        ...
        print("Design seat count = "+"%.0f"%self.cabin.n_pax)
        ...
        print("Ground clearence = "+"%.2f"%self.nacelles.ground_clearence+" m")
        print("")
        print("Cabin aisle count = "+"%.0f"%self.cabin.n_aisle)
        print("Cabin front seats = "+"%.0f"%self.cabin.n_front)
        ...
        hld_type = self.aerodynamics.hld_data[self.aerodynamics.hld_type][1]
        print("Wing high lift device code = "+hld_type)
        print("")
        ...
        print("")
        print("Characteristic Weights and breakdown")
        print("-------------------------------------------------------")
        ...
        print("Economics")
        print("-------------------------------------------------------")
        print("Gear price = "+"%.3f"%(self.economics.gear_price*1e-6)+" M$")
        print("One engine price = "+"%.3f"%(self.economics.engine_price*1e-6)+" M$")
        print("Aircraft price = "+"%.3f"%(self.economics.aircraft_price*1e-6)+" M$")
        print("")
