...
ac.power_system.reference_power = unit.W_kW(4700.)
ac.airframe.wing.area = 70.
...
var_bnd = [[unit.W_kW(3000.), unit.W_kW(6000.)],       # Design space area where to look for an optimum solution
           [50., 100.]]
