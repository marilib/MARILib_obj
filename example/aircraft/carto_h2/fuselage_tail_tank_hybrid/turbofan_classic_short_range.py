...
agmt = Arrangement(body_type = "fuselage",           # "fuselage" or "blended"
                   ...
                   power_architecture = "pte",        # "tf", "tp", "ef", "ep", "pte", , "extf", "exef"
...
ac.airframe.tail_nacelle.bli_effect = "Yes"
...
# ac.power_system.reference_thrust = unit.N_kN(140.04)
# ac.airframe.wing.area = 183.76
# ac.airframe.system.chain_power = unit.W_kW(50)
# ac.weight_cg.mtow = 91963

# ac.power_system.reference_thrust = unit.N_kN(140.12)
# ac.airframe.wing.area = 184.06
# ac.airframe.system.chain_power = unit.W_kW(100)
# ac.weight_cg.mtow = 92080

# ac.power_system.reference_thrust = unit.N_kN(140.3)
# ac.airframe.wing.area = 184.6
# ac.airframe.system.chain_power = unit.W_kW(200)
# ac.weight_cg.mtow = 92287
...
# ac.power_system.reference_thrust = unit.N_kN(133.9)
# ac.airframe.wing.area = 167.9
# ac.airframe.system.chain_power = unit.W_kW(200)
# ac.weight_cg.mtow = 86141

# ac.power_system.reference_thrust = unit.N_kN(134.2)
# ac.airframe.wing.area = 168.65
# ac.airframe.system.chain_power = unit.W_kW(400)
# ac.weight_cg.mtow = 86471
