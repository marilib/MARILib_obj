...
# ac.power_system.reference_thrust = unit.N_kN(159.9)
# ac.airframe.wing.area = 225.76
# ac.weight_cg.mtow = 116577
...
# ac.airframe.tank.width = 3
# ac.airframe.other_tank.width = 3
# ac.power_system.reference_thrust = unit.N_kN(131.4)
# ac.airframe.wing.area = 173.65
# ac.weight_cg.mtow = 91596
