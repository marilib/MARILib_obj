...
The exercise requires to fill the code where it is mentioned "Fill here"
You can solve the complete exercise with less than 20 lines of code
...
3- Implement the MDA (coupling computation). Explain the logic of the algorithm here
...
if __name__ == "__main__":
    """
    Main function executed when running the pyton file

    The functions will crash when you start, you have to make them work !
    """
    run_sequentially()
    mda()
    main_process()
