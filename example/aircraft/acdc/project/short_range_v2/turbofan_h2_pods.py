...
ac.airframe.tank.ref_length = 17
...
# Manage symetrical pod
ac.airframe.tank.mfw_factor = 1
ac.airframe.other_tank.ref_length = ac.airframe.tank.ref_length
ac.airframe.other_tank.mfw_factor = ac.airframe.tank.mfw_factor
ac.airframe.other_tank.width = ac.airframe.tank.width
ac.airframe.other_tank.gravimetric_index = ac.airframe.tank.gravimetric_index
ac.airframe.other_tank.volumetric_index = ac.airframe.tank.volumetric_index
...
var_bnd = [[unit.N_kN(100.), unit.N_kN(300.)],       # Design space area where to look for an optimum solution
           [100., 300.]]
